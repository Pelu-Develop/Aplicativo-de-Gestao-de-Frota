        ...
        <aside className="w-64 bg-surface border-r border-border flex flex-col h-full flex-shrink-0 transition-colors duration-300">
            ...
            <nav className="flex-1 overflow-y-auto py-4 px-3 flex flex-col gap-1">
                ...
                <div className="flex flex-col gap-1 mt-2">
                    ...
                    <Link to="/manutencao" className={`flex items-center gap-3 px-3 py-2 rounded-lg group transition-colors ${isActive('/manutencao') ? 'bg-primary/10 text-primary border border-primary/20' : 'text-text-muted hover:bg-surface/80 hover:text-text-primary'}`}>
                        <span className="material-symbols-outlined text-[18px]">build</span>
                        <span className="text-xs font-semibold">Manutenção</span>
                    </Link>
                </div>
